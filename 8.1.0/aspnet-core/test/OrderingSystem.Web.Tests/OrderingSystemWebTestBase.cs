...
using OrderingSystem.Models.TokenAuth;
...
{
    public abstract class OrderingSystemWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static OrderingSystemWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(OrderingSystemWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<OrderingSystemDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<OrderingSystemDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<OrderingSystemDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<OrderingSystemDbContext, Task<T>> func)
        {
            T result;
